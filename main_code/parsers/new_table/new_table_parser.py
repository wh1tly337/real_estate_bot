...
async def upn_site_parser(message, url_upn):
    ...
    if page_count > 15:
        page_count = 15
        message_text = 'Вы ввели ссылку с слишком большим количеством объявлений. Более точно настройте фильтры или оставьте все так, но я обработаю только 15 страниц'
        await bot_aiogram.send_message(chat_id=message.chat.id, text=message_text)
    ...
    for page in tqdm(range(1, page_count + 1)):
        try:
            ...
            ads_count = len(ad)
            for ad_number in range(ads_count):
                if variables.possibility is False:
                    break
                else:
                    if len(ad[ad_number]) == 1:
                        continue
                    if len(ad[ad_number]['div'][1]['div'][7]['div'][0]['div'][0]['div']) == 3:
                        price = "".join(re.findall(r"\d+", ad[ad_number]['div'][1]['div'][7]['div'][0]['div'][0]['div']['text']))
                    else:
                        price = "".join(re.findall(r"\d+", ad[ad_number]['div'][1]['div'][7]['div'][0]['div'][0]['div'][1]['text']))
                    full_address = "".join((ad[ad_number]['div'][1]['div'][1]['span']['text']).split(',')[-2:])
                    ad_url = 'https://upn.ru' + ad[ad_number]['div'][1]['a']['attributes']['href']
                    square = round(float("".join((ad[ad_number]['div'][1]['div'][2]['div'][0]['div'][1]['text']).split('/')[0])))
...
async def cian_site_parser(message, url_cian):
    ...
    try:
        ...
        for index in range(20):
            try:
                page_count = math.ceil(int("".join(re.findall(r"\d+", full_page['div'][0]['div'][0]['div'][index]['div'][0]['div'][0]['h5'][0]['_value']))) / 28)
                break
        ...
        for index in range(20):
            try:
                url_next_page = full_page['div'][0]['div'][0]['div'][index]['div'][0]['ul'][0]['li'][1]['a'][0]['_attributes']['href']
                break
        ...
        for page in tqdm(range(1, page_count + 1)):
            if variables.possibility is False:
                ...
                url_cycle = await cian_avito_url_cycle_detector(url_next_page, page)
                variables.driver.get(url=url_cycle)
                full_page = html_to_json.convert(variables.driver.page_source)['html'][0]['body'][0]
                for index in range(20):
                    try:
                        sp = index
                        ads_count = len(full_page['div'][0]['div'][0]['div'][index]['article'])
                        break

                    except Exception:
                        continue
                for ad_number in range(ads_count):  # noqa
                    ad = full_page['div'][0]['div'][0]['div'][sp]['article'][ad_number]  # noqa
                    ...
                    try:
                        ...
                        square = '-'
                    for index_1, index_2 in itertools.product(range(10), range(10)):
                        try:
                            sp_1 = len(ad['div'][0]['div'][1]['div'][0]['div'][0]['div'][index_2]['div'][index_1]['a'])
                            street_address = ad['div'][0]['div'][1]['div'][0]['div'][0]['div'][index_2]['div'][index_1]['a'][sp_1 - 2]['_value']
                            number_address = ad['div'][0]['div'][1]['div'][0]['div'][0]['div'][index_2]['div'][index_1]['a'][sp_1 - 1]['_value']
                    ...
                    for index in range(10):
                        try:
                            price = "".join(re.findall(r"\d+", ad['div'][0]['div'][1]['div'][0]['div'][0]['div'][index]['div'][0]['span'][0]['span'][0]['_value']))
                            break
...
async def yandex_site_parser(message, url_yandex):
    ...
    try:
        ...
        url_next_page = 1
        for index_1, index_2 in itertools.product(range(20), range(20)):
            try:
                url_next_page = full_page['html'][0]['body'][0]['div'][1]['div'][1]['div'][0]['div'][0]['div'][1]['div'][3]['div'][index_1]['span'][0]['label'][index_2]['button'][0]['span'][0]['a'][
                    0]['_attributes']['href']
                ...
                if point is True:
                    ...
                    if index == -1:
                        ...
                        if index == -1:
                            ...
                            index = index + 6
                            url_cycle = f"{url_next_page[:index]}{page}{url_next_page[index + 1:]}"
                    else:
                        index = index + 6
                        url_cycle = f"{url_next_page[:index]}{page}{url_next_page[index + 1:]}"
                    logger.info(url_cycle)
                    ...
                    for ad_number in range(ads_count):
                        ad = full_page['html'][0]['body'][0]['div'][1]['div'][1]['div'][0]['div'][0]['div'][1]['div'][3]['ol'][0]['li'][ad_number]
                        if len(ad) != 3:
                            continue
                        try:
                            ad = full_page['html'][0]['body'][0]['div'][1]['div'][1]['div'][0]['div'][0]['div'][1]['div'][3]['ol'][0]['li'][ad_number]['div'][0]['div'][0]
                        ...
                        for index in range(20):
                            try:
                                address = str(ad['div'][0]['div'][0]['div'][0]['a'][index]['_value']).replace(',', '')
                        ...
                        if len(full_address) == 0:
                            ...
                            for index in range(20):
                                try:
                                    address = str(ad['div'][0]['div'][0]['div'][0]['_values'][index]).replace(',', '')
                                    full_address.append(address)
...
async def avito_site_parser(message, url_avito):
    ...
    try:
        ...
        if page_count == 1:
            ...
            for index in range(20):
                try:
                    url_next_page = full_page['div'][2]['div'][2]['div'][2]['div'][index]['div'][1]['div'][0]['a'][1]['_attributes']['href']
        ...
        for page in tqdm(range(1, page_count + 1)):
            if variables.possibility is False:
                ...
                url_cycle = await cian_avito_url_cycle_detector(url_next_page, page)  # noqa
                variables.driver.get(url=url_cycle)
                full_page = html_to_json.convert(variables.driver.page_source)['html'][0]['body'][0]['div'][0]['div'][0]
                for index in range(10):
                    try:
                        ...
                        continue
                for ad_number in range(ads_count):  # noqa
                    ad = full_page['div'][2]['div'][2]['div'][2]['div'][sp]['div'][0]['div'][ad_number]  # noqa
                    if len(ad) != 3:
                        continue
                    try:
                        ad = full_page['div'][2]['div'][2]['div'][2]['div'][sp]['div'][0]['div'][ad_number]

                    except Exception:
                        continue
                    for index_1, index_2 in itertools.product(range(10), range(10)):
                        try:
                            full_address = ad['div'][0]['div'][1]['div'][index_1]['div'][index_2]['span'][0]['span'][0]['_value']
                            break
