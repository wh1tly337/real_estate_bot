...
markup_start.add(btn1_overflow, btn2_overflow)
...
markup_confidence = types.ReplyKeyboardMarkup(resize_keyboard=True)
btn1_confidence = types.KeyboardButton('Да, уверен')
btn2_confidence = types.KeyboardButton('Нет, давай продолжим')
markup_confidence.add(btn1_confidence, btn2_confidence)
